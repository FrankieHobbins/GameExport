...
def export(self, path, export_col):
        if self.process_without_export:
            return
        bpy.ops.export_scene.gltf(filepath=path, **GLBExport.export_glb_settings(self))

        def export_glb_settings(self):
            return {
                ...
                "export_cameras": bpy.context.scene.FBXKeepLightsAndCameras,
                "use_selection": True,
                "use_visible": False,
                ...
                "export_lights": bpy.context.scene.FBXKeepLightsAndCameras,
